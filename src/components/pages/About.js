        ...
        <>
            <div className='studently'>
                ...
                <h3>Axcess Fund aims to provide a funding platform where individuals can borrow money instantly to pay their essential bills.
                    ...
                    Axcess Fund works like following: User sign up using email/phone number.
                    <br />
                    Then add bills they would need assistant paying.
                    <br />
                    Once bill payment processor selected, user will be prompt to provide account number, and billing address/phone number of the company.
                    <br />
                    Then user will have option to apply for partial fund to cover-up bill or apply fund to pay full bill. Once applied, user will get instant decision based on soft credit pull with just full-name and date of birth.
                    <br />
                    User will also get option to select the term (e.x. 3,6,12,18 months) and enroll on auto-pay.
                    <br />

                    No hidden or ate fees or interest charge as long as user pay on time within selected term.
                    <br />
                    <br />
                    <h4>
                        The mission of Axcess Fund is to create easy-to-use-platform that provides instant-access of fund for users to borrow money they need to pay their essential-bills on time to avoid enormous late fee and potential debt collection notices that heavily impact their credit score/credit worthiness. This cause customers more than expected: high-interest auto/home loan, credit cards and more. Using Axcess Fund platform, one can avoid such and pay only what being borrowed.
                ...
                <br />
                <h3>Email: support@axcessf.com</h3>
                <br />
                <div><a href='/contact'>Contact with us Directly</a></div>
